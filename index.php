...
-->
     ...
     <meta name="description" content="Fabriquant de chocolat officiel pour les étudiants du groupe 2285 à la haute école de la province de Liège">
                    ...
                    <div class="owl-carousel owl-theme">
                         <div class="item item-first">
                              <figure class="item-bg">
                                   <img src="./content/slide1.jpg" alt="Tasse de chcocolat chaud" class="item-img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3><?php echo('Coucou, je vend du chocolat !'); ?></h3>
                         ...
                         <div class="item item-second">
                              <figure class="item-bg">
                                   <img src="./content/slide2.jpg" alt="Des pralines au chocolat" class="item-img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                         ...
                         <div class="item item-third">
                              <figure class="item-bg">
                                   <img src="./content/slide3.jpg" alt="Des petits cupcakes au chocolat avec des pépites" class="item-img">
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
